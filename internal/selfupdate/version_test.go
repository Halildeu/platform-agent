...
func TestEvaluateVersionPolicy(t *testing.T) {
	cases := []struct {
		...
		{"equal to current and high-water is noop", "1.2.3", "1.2.3", "1.2.3", false, true, ""},
		{"equal to current above high-water is noop", "1.2.3", "1.2.3", "1.2.2", false, true, ""},
		{"equal to rolled-back current below high-water is replay", "1.2.3", "1.2.3", "1.2.4", false, false, ErrVersionReplay},
